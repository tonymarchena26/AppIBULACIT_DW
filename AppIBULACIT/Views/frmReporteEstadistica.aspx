<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmReporteEstadistica.aspx.cs" Inherits="AppIBULACIT.Views.frmReporteEstadistica" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h1><asp:Label Text="Bitacora de Estadistica" runat="server"></asp:Label></h1>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('[id*=gvEstadistica]').prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable({
                dom: 'Bfrtip',
    ...
    <asp:GridView ID="gvEstadistica" OnRowCommand="gvEstadistica_RowCommand" runat="server" AutoGenerateColumns="False" 
                ...
                <script >
                    new Chart(document.getElementById("vistas-chart"), {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: "Estadistica por fabricante",
                        ...
                        options: {
                            title: {
                                display: true,
                                text: 'Estadistica por fabricante'
                            }
                        }
                    });
                </script>
